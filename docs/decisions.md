...
| D-88 | 2026-09-15 | CI 工作流全家桶：单 job 整脚本入 CI（A1）+ 工具链钉版 + --locked + cargo-deny 供应链 + tag→Draft 发布链（E2）+ dependabot 收窄 actions 月更（G-b） | docs/archive/ci-workflow-suite.md |
